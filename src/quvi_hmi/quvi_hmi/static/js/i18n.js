...
(function () {
    const dict = {
        ko: {
            ...
            'status.productTitle': '검사 품종 선택',
            'product.applyNote': '검사 진행 중에는 전환 불가',
            'product.selectLabel': '품종',
            'product.loadingOption': '로딩 중...',
            'product.selectBtn': '선택',
            'product.currentLabel': '현재 품종',
            'product.createLabel': '품종 등록',
            'product.createPlaceholder': '품종 id',
            'product.createBtn': '등록',
            'product.noneSelected': '품종을 선택하세요.',
            'product.noProducts': '등록된 품종 없음',
            'product.none': '미선택',
            'product.ready': '준비됨',
            'product.incomplete': '자산 미비',
            'product.idRequired': '품종 id를 입력하세요.',
            'product.created': '품종 등록 요청됨.',
            ...
            'printer.control': '프린터 제어',
            'printer.nozzle': '노즐',
            'printer.bed': '베드',
            'printer.progress': '진행률',
            'printer.file': '출력 파일',
            'printer.selectModel': '출력 모델 선택',
            'printer.startPrint': '출력 시작',
            'printer.pause': '일시 정지',
            'printer.resume': '재개',
            'printer.cancel': '출력 취소',
            'printer.advanced': '고급 설정',
            'printer.state.printing': '출력 중',
            'printer.state.complete': '출력 완료',
            'printer.state.standby': '대기 중',
            'printer.state.paused': '일시 정지됨',
            'printer.state.cancelled': '취소됨',
            'printer.state.error': '오류',
            'printer.noModels': '사용 가능한 모델 파일 없음',
        },
        en: {
            ...
            'status.productTitle': 'Inspection Product',
            'product.applyNote': 'Cannot switch while an inspection is running',
            'product.selectLabel': 'Product',
            'product.loadingOption': 'Loading...',
            'product.selectBtn': 'Select',
            'product.currentLabel': 'Current Product',
            'product.createLabel': 'Register Product',
            'product.createPlaceholder': 'product id',
            'product.createBtn': 'Register',
            'product.noneSelected': 'Select a product.',
            'product.noProducts': 'No products registered',
            'product.none': 'None selected',
            'product.ready': 'Ready',
            'product.incomplete': 'Incomplete',
            'product.idRequired': 'Enter a product id.',
            'product.created': 'Product registration requested.',
            ...
            'printer.selectModel': 'Select Print Model',
            'printer.startPrint': 'Start Print',
            'printer.pause': 'Pause',
            'printer.resume': 'Resume',
            'printer.cancel': 'Cancel Print',
            'printer.advanced': 'Advanced',
            'printer.state.printing': 'Printing',
            'printer.state.complete': 'Complete',
            'printer.state.standby': 'Standby',
            'printer.state.paused': 'Paused',
            'printer.state.cancelled': 'Cancelled',
            'printer.state.error': 'Error',
            'printer.noModels': 'No model files available',
        },
        ja: {
            ...
            'status.productTitle': '検査品種選択',
            'product.applyNote': '検査進行中は切り替え不可',
            'product.selectLabel': '品種',
            'product.loadingOption': '読み込み中...',
            'product.selectBtn': '選択',
            'product.currentLabel': '現在の品種',
            'product.createLabel': '品種登録',
            'product.createPlaceholder': '品種ID',
            'product.createBtn': '登録',
            'product.noneSelected': '品種を選択してください。',
            'product.noProducts': '登録された品種がありません',
            'product.none': '未選択',
            'product.ready': '準備完了',
            'product.incomplete': '資産不備',
            'product.idRequired': '品種IDを入力してください。',
            'product.created': '品種登録要求済み。',
            ...
            'printer.title': '3Dプリンター',
            'printer.control': 'プリンター制御',
            'printer.nozzle': 'ノズル',
            'printer.bed': 'ベッド',
            'printer.progress': '進捗',
            'printer.file': 'プリントファイル',
            'printer.selectModel': 'モデル選択',
            'printer.startPrint': 'プリント開始',
            'printer.pause': '一時停止',
            'printer.resume': '再開',
            'printer.cancel': 'プリント中止',
            'printer.advanced': '詳細設定',
            'printer.state.printing': 'プリント中',
            'printer.state.complete': '完了',
            'printer.state.standby': '待機中',
            'printer.state.paused': '一時停止中',
            'printer.state.cancelled': '中止',
            'printer.state.error': 'エラー',
            'printer.noModels': '利用可能なモデルファイルがありません',
        },
    };
