...
| **카메라** | InnoMaker USB U20CAM × 2 | Zone 1 (핸드캠: 파지 제어용) 및 Zone 2 (고정캠: 품질 검사용) |
| **AI 및 알고리즘** | LeRobot ACT + SSIM | 모방 학습 파지 제어, 정사영 형상비교 검사 |
...
* **실시간 MJPEG 비디오 스트리밍**
  * Zone 1 핸드캠 피드, Zone 2 고정캠 피드, 품질 비전 정사영 디버깅 뷰.
...
* **Vision & AI**: OpenCV 4.9, scikit-image, PyTorch 2.x, Hugging Face LeRobot
