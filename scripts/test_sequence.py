...
#   50 → 약 11.5 RPM (느림)
#   80 → 약 18.3 RPM (보통)
PROFILE_VELOCITY       = 50    # 팔 관절 속도
PROFILE_ACCEL          = 15    # 가속도 (낮을수록 부드럽게 출발·정지)
PROFILE_VELOCITY_GRIP  = 80    # 그리퍼 속도
PROFILE_ACCEL_GRIP     = 20

# 이동 완료 대기 시간 (Profile_Velocity 기준 예상 시간 + 여유)
MOVE_WAIT              = 3.5   # 초 (관절 이동)
GRIPPER_WAIT           = 1.2   # 초 (그리퍼)
SETTLE                 = 0.3   # 정착 여유
