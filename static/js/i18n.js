...
(function () {
    const dict = {
        ko: {
            ...
            'demo.notice.hint': '상단에서 <strong>정상품 / 불량품</strong> 중 보고 싶은 검사를 고른 뒤 <span class="demo-notice-start">▶ 시작</span> 버튼을 누르면 해당 사이클이 실행됩니다. 두 가지 모두 확인해 보세요.',
            'demo.notice.closeBtn': '둘러보기 시작',
            'demo.toast.simOnly': '데모 모드 — 실기에서만 동작합니다',
            'demo.fail.reason': '270° 레이어 분리, 구멍 3개 검출 + ML 이상탐지 34.08 (임계 24.93)',
        ...
        en: {
            ...
            'demo.notice.hint': 'Pick <strong>a passing or a failing part</strong> above, then click <span class="demo-notice-start">▶ Start</span> to run that cycle. Both are worth watching.',
            'demo.notice.closeBtn': 'Start Exploring',
            'demo.toast.simOnly': 'Demo mode — only available on real hardware',
            'demo.fail.reason': 'Layer separation at 270°, 3 holes detected + ML anomaly 34.08 (threshold 24.93)',
        ...
        ja: {
            ...
            'demo.notice.hint': '上部で <strong>良品 / 不良品</strong> のうち見たい検査を選び、<span class="demo-notice-start">▶ 開始</span> ボタンを押すとそのサイクルが実行されます。ぜひ両方ご覧ください。',
            'demo.notice.closeBtn': '見学を開始',
            'demo.toast.simOnly': 'デモモード — 実機でのみ動作します',
            'demo.fail.reason': '270°でレイヤー分離、穴3個検出 + ML異常検知 34.08（しきい値 24.93）',
