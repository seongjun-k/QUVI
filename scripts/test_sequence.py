...
사용법 (도커 안에서):
  python3 /workspace/scripts/test_sequence.py
"""
...
POSE_DELAY    = 1.5   # 각 포즈 이동 후 대기 (초)
GRIPPER_DELAY = 0.5   # 그리퍼 동작 후 대기 (초)
INSPECT_WAIT  = 3.0   # 판정 대기 시간 (초) — 추후 실제 신호로 교체
