...
**미션** — 야간에 3D프린터를 돌리는 소규모 출력 사업자가 실패를 아침까지 아무도 모르는 탓에 잃는 가동률을, 무인 검사·분류 로봇으로 되돌립니다.

**성과를 재는 숫자 하나** — 주 단위, 웹 데모에서 검사 사이클을 끝까지 본 사용자 수. 들어왔다 나간 사람이 아니라 판정 결과까지 확인한 사람만 셉니다. (Google Analytics 4로 집계, 개인 식별 정보는 수집하지 않습니다.)
