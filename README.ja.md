...
**ミッション** — 夜通しプリンターを稼働させる小規模事業者が、失敗に朝まで気づけないために失う稼働率を、無人検査・仕分けロボットで取り戻します。

**成果を測る数字はひとつ** — 週あたり、Webデモで検査サイクルを最後まで見た利用者数。訪問しただけの人ではなく、判定結果まで確認した人だけを数えます。(Google Analytics 4で集計し、個人を識別する情報は収集しません。)
